...
public class EffectClip
{
	...
	public void PreLoad()
	{
		...
		{
			this.effectPrefab = ResourceManager.Instance.Load(effect_fullPath) as GameObject;
		}

		if (this.beHitEffect_Path != string.Empty && this.beHitEffect_Prefab == null)
		{
			this.beHitEffect_Prefab = ResourceManager.Instance.Load(beHitEffect_Path) as GameObject;
		}
	}
